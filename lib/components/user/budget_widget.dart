...
class BudgetWidget extends StatefulWidget {
  ...
  const BudgetWidget({Key? key, this.budget, this.lobbyId, this.hostId}) : super(key: key);

  @override
  _BudgetWidgetState createState() => _BudgetWidgetState();
}

class _BudgetWidgetState extends State<BudgetWidget> with TickerProviderStateMixin{
                ...
                children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            'Items', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                                          ),
                                        ],
                                      ),
                                      Text(
                                        'Prices', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                                      ),
                                    ],
                                  ),
                                ),
                                _model.showExpenses(widget.lobbyId!, widget.hostId!),
                              ],
                            ),
                        ),
                      ],
                  ...
                  SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 20,),
                        Text('Total Expenses: ₱${_model.total}', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Text(
                                    'Participants', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                                  ),
                                ],
                              ),
                              Text(
                                'Budgets', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
                              ),
                            ],
                          ),
                        ),
