    ...
    return GestureDetector(
      onLongPress: () async {
        if(currentUserId == hostId) {
            ...
            builder: ((context) =>
                AlertDialog(
                  ...
                  actions: [
                    TextButton(
                      onPressed: () async {
                        await UserController.deleteSpecificExpense(lobbyId!, label!);
                        Fluttertoast.showToast(msg: '${label} Expense Deleted.',
          ...
          Fluttertoast.showToast(msg: 'Only a Host can remove expenses.',
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.BOTTOM,
            timeInSecForIosWeb: 2,
